...
class AboutController extends Controller
{
    ...
    public function index()
    {
        ...
        $about_en = Option::where('key','about')->where('lang','en')->first();

        $about = Option::where('key','about')->where('lang',$current_lang)->first();
        if(empty($about)){
            $about = new Option;
            $about->key = 'about';
            $about->lang = $current_lang;
            $about->value = $about_en->value;
            $about->save();
